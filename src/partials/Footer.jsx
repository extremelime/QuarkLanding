...
function Footer() {
  return (
    <footer>
        ...
        <div className="pb-4">
        <span className="pr-4">
          <a href="https://github.com/bifilm/quarkiql"  style={{ display: 'inline-block', margin:'auto', width: '30px',}} className="text-gray-800 hover:text-gray-700 transition duration-150 ease-in-out" aria-label="Github">
            <svg width="30" height="30" className="fill-current" xmlns="http://www.w3.org/2000/svg" 
