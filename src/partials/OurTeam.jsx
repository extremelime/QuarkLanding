    ...
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <p className="text-xl mt-12 text-center tracking-normal text-gray-600">For all questions, suggestions, and support,<br />please get in touch with us:<div className="m-10 max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center "><a className="max-h-[2.5em] min-w-[5.5em] rounded-lg btn text-white bg-black hover:bg-gray-800 w-full sm:w-auto select-none" alt="Contact us" href="mailto:quarkiql@gmail.com"><br /><MdOutlineMailOutline style={{display:'inline',scale:"1.35"}}/></a></div></p>
        </div>
      </div>
    </section>
  );
